...
5. 若要直接配置 Dataset、Pipeline、Build、Schedule、Sync scope，读 [Palantir 资源 Scope 权限配置参照表](synthesis/palantir-resource-scope-configuration-reference.md)。
6. 按需回查 Marking 机制、实现方案、进阶机制和本轮 Data Integration Story：`docs/raw/11`、`12`、`13`、`50` 到 `56`。
