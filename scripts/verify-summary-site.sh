...
check_contains "$ROOT/pages/pro-code-capability.html" "href=\"#src-code-repositories\""
check_contains "$ROOT/pages/pro-code-capability.html" "href=\"#src-pipeline-export\""
